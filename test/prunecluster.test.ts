...
import {PruneCluster, PruneClusterMarker, Bounds} from '../src/PruneCluster';
...
describe('PruneCluster', () => {
    ...
    test('should register a marker', () => {
        const marker = new PruneClusterMarker(10, 20);
        pruneCluster.RegisterMarker(marker);
        expect(pruneCluster.GetMarkers()).toContain(marker);
    });

    test('should remove all markers', () => {
        const marker1 = new PruneClusterMarker(10, 20);
        const marker2 = new PruneClusterMarker(30, 40);
    ...
    test('should handle markers with filtered flag in ComputeBounds', () => {
        const marker1 = new PruneClusterMarker(10, 20, {}, 0, 1, true);
        const marker2 = new PruneClusterMarker(30, 40);
        pruneCluster.RegisterMarkers([marker1, marker2]);
    ...
    test('should handle markers with different categories', () => {
        const marker1 = new PruneClusterMarker(10, 20, {}, 1); // category 1
        const marker2 = new PruneClusterMarker(30, 40, {}, 2); // category 2
        pruneCluster.RegisterMarkers([marker1, marker2]);
        const clusters = pruneCluster.ProcessView({minLat: 0, maxLat: 50, minLng: 0, maxLng: 50});
    ...
    test('should handle markers with different weights', () => {
        const marker1 = new PruneClusterMarker(10, 20, {}, 0, 2); // weight: 2
        const marker2 = new PruneClusterMarker(30, 40, {}, 0, 3); // weight: 3
        pruneCluster.RegisterMarkers([marker1, marker2]);
        const clusters = pruneCluster.ProcessView({minLat: 0, maxLat: 50, minLng: 0, maxLng: 50});
    ...
    test('should handle markers with the same position', () => {
        const marker1 = new PruneClusterMarker(10, 20);
        const marker2 = new PruneClusterMarker(10, 20); // Same position as marker1
        pruneCluster.RegisterMarkers([marker1, marker2]);
        const clusters = pruneCluster.ProcessView({minLat: 0, maxLat: 50, minLng: 0, maxLng: 50});
    ...
    test('should handle markers with custom data', () => {
        const marker1 = new PruneClusterMarker(10, 20, {name: 'Marker 1'});
        pruneCluster.RegisterMarker(marker1);
    ...
    test('should handle markers with filtered flag', () => {
        const marker1 = new PruneClusterMarker(10, 20, {}, 0, 1, true); // filtered = true
        pruneCluster.RegisterMarker(marker1);
        const bounds: Bounds = {minLat: 0, maxLat: 50, minLng: 0, maxLng: 50};
        const markersInArea = pruneCluster.FindMarkersInArea(bounds);
    ...
    test('should use native sort when nbChanges exceeds 300', () => {
        for (let i = 0; i < 350; i++) {
            const marker = new PruneClusterMarker(i, i);
            pruneCluster.RegisterMarker(marker);
        }
    ...
    test('should compute bounds for clusters at the edge of view', () => {
        const marker1 = new PruneClusterMarker(10, 20);
        const marker2 = new PruneClusterMarker(50, 60);
        pruneCluster.RegisterMarkers([marker1, marker2]);
    ...
    test('should filter out markers with filtered flag set to true', () => {
        const marker1 = new PruneClusterMarker(10, 20, {}, 0, 1, true); // filtered
        const marker2 = new PruneClusterMarker(30, 40, {}, 0, 1, false); // not filtered
        pruneCluster.RegisterMarkers([marker1, marker2]);
